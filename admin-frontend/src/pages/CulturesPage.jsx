...
const modalFields = [
  ...
  { name: 'description', label: '简介', type: 'textarea', placeholder: '请输入简介', required: true },
  { name: 'details', label: '详细内容', type: 'textarea', placeholder: '请输入详细内容', rows: 6 },
...
function CulturesPage() {
  ...
  const handleSubmit = async (data) => {
    if (editingItem) {
      await cultureApi.update(editingItem.id, data);
    } else {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900">文化内容管理</h1>
        <button
      ...
      <ContentModal
        ...
        title={editingItem ? '编辑文化内容' : '添加文化内容'}
        fields={modalFields}
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                确定要删除文化内容「<span className="font-medium">{deleteConfirm.title}</span>」吗？
              </p>
